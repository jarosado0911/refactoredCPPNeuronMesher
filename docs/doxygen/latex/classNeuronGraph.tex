...
\begin{DoxyCompactItemize}
\item 
std\+::map$<$ int, std\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{classNeuronGraph_a76f4e1ec5197389c1c073a2c891a4e2e}{get\+Neighbor\+Map}} (const std\+::map$<$ int, \mbox{\hyperlink{structSWCNode}{SWCNode}} $>$ \&node\+Set) const
\begin{DoxyCompactList}\small\item\em Builds a neighbor map from a set of nodes. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
std\+::map$<$ int, \mbox{\hyperlink{structSWCNode}{SWCNode}} $>$ \mbox{\hyperlink{classNeuronGraph_a312adb405dceafb6b1a736bd8e4ded88}{nodes}}
\begin{DoxyCompactList}\small\item\em Map of node IDs to \mbox{\hyperlink{structSWCNode}{SWCNode}} objects. \end{DoxyCompactList}\item 
std\+::map$<$ int, std\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{classNeuronGraph_ae9cbc0c7feb5dcfbc415fb65ca5f782a}{edges}}
\begin{DoxyCompactList}\small\item\em Adjacency list representation of the neuron graph. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{classNeuronGraph_a453e31c723b0dc9d692d8663d93be51a_icgraph}
\end{center}
\end{figure}
...
\end{center}
\end{figure}
\mbox{\Hypertarget{classNeuronGraph_a76f4e1ec5197389c1c073a2c891a4e2e}\label{classNeuronGraph_a76f4e1ec5197389c1c073a2c891a4e2e}} 
\index{NeuronGraph@{NeuronGraph}!getNeighborMap@{getNeighborMap}}
\index{getNeighborMap@{getNeighborMap}!NeuronGraph@{NeuronGraph}}
\doxysubsubsection{\texorpdfstring{getNeighborMap()}{getNeighborMap()}}
{\footnotesize\ttfamily std\+::map$<$ int, std\+::vector$<$ int $>$ $>$ Neuron\+Graph\+::get\+Neighbor\+Map (\begin{DoxyParamCaption}\item[{const std\+::map$<$ int, \mbox{\hyperlink{structSWCNode}{SWCNode}} $>$ \&}]{node\+Set }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [private]}}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em node\+Set} & Set of nodes to process \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
This method constructs an undirected graph representation of the neuron morphology by creating neighbor relationships between connected nodes. For each node in the input set, it establishes bidirectional connections between the node and its parent (if the parent exists in the node\+Set).

The resulting neighbor map allows efficient traversal of the neuron\textquotesingle{}s topology in any direction, which is essential for various analysis and processing tasks such as trunk extraction and topological sorting.

\begin{DoxyNote}{Note}
Only nodes present in the input node\+Set are included in the neighbor map 

The method creates bidirectional edges (A→B and B→A) for each parent-\/child relationship 
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classNeuronGraph_ae750a60642aa3d1a30ec9265795cd065}{get\+Trunks()}} for the primary use of this method 

\mbox{\hyperlink{classNeuronGraph_ab66e25466d6c0b228b95c118963e7cb0}{topological\+Sort()}} for another application of the neighbor map 
\end{DoxySeeAlso}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classNeuronGraph_a76f4e1ec5197389c1c073a2c891a4e2e_icgraph}
\end{center}
\end{figure}
...
\end{DoxyNote}
\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classNeuronGraph_a76f4e1ec5197389c1c073a2c891a4e2e}{get\+Neighbor\+Map()}} for the \mbox{\hyperlink{globals_8h_a65b5e8f0673c2dba7ec632133f036a21}{graph}} representation used internally 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classNeuronGraph_ae750a60642aa3d1a30ec9265795cd065_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\mbox{\hyperlink{classNeuronGraph_a4da98a459bd4ddaa00df5ed08bc80477}{set\+Soma()}} for adding missing soma \mbox{\hyperlink{classNeuronGraph_a312adb405dceafb6b1a736bd8e4ded88}{nodes}} 
\end{DoxySeeAlso}
...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{classNeuronGraph_a6b0c1b97c8866106d3bb7f803b94f6f4_icgraph}
\end{center}
\end{figure}
...
\mbox{\Hypertarget{classNeuronGraph_ae9cbc0c7feb5dcfbc415fb65ca5f782a}\label{classNeuronGraph_ae9cbc0c7feb5dcfbc415fb65ca5f782a}} 
\index{NeuronGraph@{NeuronGraph}!edges@{edges}}
\index{edges@{edges}!NeuronGraph@{NeuronGraph}}
\doxysubsubsection{\texorpdfstring{edges}{edges}}
{\footnotesize\ttfamily std\+::map$<$int, std\+::vector$<$int$>$ $>$ Neuron\+Graph\+::edges\hspace{0.3cm}{\ttfamily [private]}}



Adjacency list representation of the neuron graph. 

\mbox{\Hypertarget{classNeuronGraph_a312adb405dceafb6b1a736bd8e4ded88}\label{classNeuronGraph_a312adb405dceafb6b1a736bd8e4ded88}} 
\index{NeuronGraph@{NeuronGraph}!nodes@{nodes}}
\index{nodes@{nodes}!NeuronGraph@{NeuronGraph}}
\doxysubsubsection{\texorpdfstring{nodes}{nodes}}
{\footnotesize\ttfamily std\+::map$<$int,\mbox{\hyperlink{structSWCNode}{SWCNode}}$>$ Neuron\+Graph\+::nodes\hspace{0.3cm}{\ttfamily [private]}}



Map of node IDs to \mbox{\hyperlink{structSWCNode}{SWCNode}} objects. 
