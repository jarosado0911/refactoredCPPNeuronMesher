\hypertarget{callbacks_8h}{}\doxysection{include/viewer/callbacks.h File Reference}
\label{callbacks_8h}\index{include/viewer/callbacks.h@{include/viewer/callbacks.h}}
...
\item 
void \mbox{\hyperlink{callbacks_8h_a0b9e239c8889734711f29fe45551605b}{key\+Callback}} (GLFWwindow $\ast$window, int key, int scancode, int action, int mods)
\begin{DoxyCompactList}\small\item\em Handles keyboard input events. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{callbacks_8h_ae41a3951e1196401047b29ad1d37c6ae}{mouse\+Button\+Callback}} (GLFWwindow $\ast$window, int button, int action, int mods)
\begin{DoxyCompactList}\small\item\em Handles mouse button input events. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{callbacks_8h_ae49f0c4c2064be8fbcf555f46460b7df}{cursor\+Pos\+Callback}} (GLFWwindow $\ast$window, double xpos, double ypos)
\begin{DoxyCompactList}\small\item\em Handles mouse cursor movement. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{callbacks_8h_aa9b224479e8c1cc5251b8e7f3fdabacd}{scroll\+Callback}} (GLFWwindow $\ast$window, double xoffset, double yoffset)
\begin{DoxyCompactList}\small\item\em Handles mouse scroll events. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
GLFW input handling callbacks for neuron visualization. 

This header defines the callback functions that handle user input through GLFW, including keyboard, mouse, and scroll wheel interactions for the neuron viewer. These callbacks modify the global state in \mbox{\hyperlink{globals_8h}{globals.\+h}} to control the visualization.
...
\mbox{\Hypertarget{callbacks_8h_ae49f0c4c2064be8fbcf555f46460b7df}\label{callbacks_8h_ae49f0c4c2064be8fbcf555f46460b7df}} 
\index{callbacks.h@{callbacks.h}!cursorPosCallback@{cursorPosCallback}}
\index{cursorPosCallback@{cursorPosCallback}!callbacks.h@{callbacks.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=253pt]{callbacks_8h_ae49f0c4c2064be8fbcf555f46460b7df_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{callbacks_8h_a0b9e239c8889734711f29fe45551605b}\label{callbacks_8h_a0b9e239c8889734711f29fe45551605b}} 
\index{callbacks.h@{callbacks.h}!keyCallback@{keyCallback}}
\index{keyCallback@{keyCallback}!callbacks.h@{callbacks.h}}
...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{callbacks_8h_a0b9e239c8889734711f29fe45551605b_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=225pt]{callbacks_8h_a0b9e239c8889734711f29fe45551605b_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{callbacks_8h_ae41a3951e1196401047b29ad1d37c6ae}\label{callbacks_8h_ae41a3951e1196401047b29ad1d37c6ae}} 
\index{callbacks.h@{callbacks.h}!mouseButtonCallback@{mouseButtonCallback}}
\index{mouseButtonCallback@{mouseButtonCallback}!callbacks.h@{callbacks.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=267pt]{callbacks_8h_ae41a3951e1196401047b29ad1d37c6ae_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{callbacks_8h_aa9b224479e8c1cc5251b8e7f3fdabacd}\label{callbacks_8h_aa9b224479e8c1cc5251b8e7f3fdabacd}} 
\index{callbacks.h@{callbacks.h}!scrollCallback@{scrollCallback}}
\index{scrollCallback@{scrollCallback}!callbacks.h@{callbacks.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=232pt]{callbacks_8h_aa9b224479e8c1cc5251b8e7f3fdabacd_icgraph}
\end{center}
\end{figure}
